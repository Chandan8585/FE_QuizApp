...
export const signUpHandler = async(name,  mobile, email, password)=> {
   
 try {
    const data =await axios.post("https://wicked-plum-sea-urchin.cyclic.cloud/auth/register", {
      userName: name, number: mobile, email : email, password: password
    })
...
//     <form onSubmit={handleFormSubmit} className='signUp-container'>
//     <div className="form-container  d-flex direction-column lb-in-container">
...
//       </div>
//       <div>
//         <button className="signUp-container-button button btn-primary btn-login cursor">
//           Submit
//         </button>
//       </div>
//     </form>
