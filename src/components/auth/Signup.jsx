...
//  const {userName, mobile, emailID, password} = useAuth();
 const handleSubmit = async (userName, mobile, emailID,password )=> {
    // console.log(values)
    try {
        const response = await axios.post("http://localhost:8080/auth/register", {
            userName: userName, number: mobile, email: emailID, password: password
        });
   ...
   >
    <Form >
        ...
        <div className='form-container'>
            ...
            <Field type="text" className="form-input-log lh-ls" name='mobile' placeholder= "Enter your Phone Number"/> 
            <ErrorMessage name='mobile' component='div' className='error-message'/>

        </div>
        <div className='form-container'>
            <label htmlFor='emailID' className="form-label">Email ID</label>
            <Field type="text" className="form-input-log lh-ls" name='emailID' placeholder= "Enter your Email ID"/> 
            <ErrorMessage name='emailID' component='div' className='error-message'/>

        </div>
        <div className='form-container'>
            <label htmlFor='password' className="form-label">Password</label>
            <Field type="text" className="form-input-log lh-ls" name='password' placeholder= "Enter your password"/> 
            <ErrorMessage name='password' component='div' className='error-message'/>

        </div>
        {/* <div className='form-container'>
            <label htmlFor='confirmPassword' className="form-label">Confirm Password</label>
            <Field type="text" className="form-input-log lh-ls" name='confirmPassword' placeholder= "Enter Confirm Password"/> 
